...
2. **Critic** - "Here's what could go wrong"  
3. **Realist** - "Here's what actually works"
...
2. **Speed**: Cache common patterns
3. **Clarity**: Explain the reasoning
4. **Control**: Let users pick perspectives
...
3. **What's the minimum viable discussion?**
...
3. Test on 10 real questions
4. Measure if it's actually better
...
2. **It's Focused**: Just reduce errors
3. **It's Measurable**: Clear success metrics
4. **It's Useful**: Solves real problem
5. **It's Buildable**: 2 months, not 8

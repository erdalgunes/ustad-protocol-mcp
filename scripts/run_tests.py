...
class UstadTestRunner:
    ...
    def run_unit_tests(self, verbose: bool = False) -> Dict[str, Any]:
        ...
        cmd = ["python", "-m", "pytest", "tests/", "-m", "unit", "--json-report", "--json-report-file=test_results_unit.json"]
        if verbose:
            cmd.append("-v")
    ...
    def run_integration_tests(self, verbose: bool = False) -> Dict[str, Any]:
        ...
        cmd = ["python", "-m", "pytest", "tests/", "-m", "integration", "--json-report", "--json-report-file=test_results_integration.json"]
        if verbose:
            cmd.append("-v")
    ...
    def run_accuracy_tests(self, verbose: bool = False) -> Dict[str, Any]:
        ...
        cmd = ["python", "-m", "pytest", "tests/", "-m", "accuracy", "--json-report", "--json-report-file=test_results_accuracy.json"]
        if verbose:
            cmd.append("-v")
    ...
    def run_performance_tests(self, verbose: bool = False) -> Dict[str, Any]:
        ...
        cmd = ["python", "-m", "pytest", "tests/", "-m", "performance", "--benchmark-only", "--json-report", "--json-report-file=test_results_performance.json"]
        if verbose:
            cmd.append("-v")
    ...
    def run_edge_case_tests(self, verbose: bool = False) -> Dict[str, Any]:
        ...
        cmd = ["python", "-m", "pytest", "tests/", "-m", "edge_case", "--json-report", "--json-report-file=test_results_edge_cases.json"]
        if verbose:
            cmd.append("-v")
    ...
    def run_all_tests(self, verbose: bool = False, parallel: bool = False) -> Dict[str, Any]:
        ...
        cmd = ["python", "-m", "pytest", "tests/", "--json-report", "--json-report-file=test_results_all.json"]
    ...
    def run_coverage_report(self) -> Dict[str, Any]:
        ...
        cmd = ["python", "-m", "pytest", "tests/", "--cov=src", "--cov-report=html:htmlcov", "--cov-report=term"]
        result = subprocess.run(cmd, capture_output=True, text=True)
...
"""
    ...
    def main(self):
        ...
        parser.add_argument("--test-type", choices=["unit", "integration", "accuracy", "performance", "edge_case", "all"], 
                          default="all", help="Type of tests to run")
        parser.add_argument("--verbose", "-v", action="store_true", help="Verbose output")
        parser.add_argument("--parallel", "-p", action="store_true", help="Run tests in parallel")
        parser.add_argument("--coverage", "-c", action="store_true", help="Generate coverage report")
        parser.add_argument("--validate-accuracy", action="store_true", help="Validate detector accuracy")
        ...
        if args.validate_accuracy:
            detectors = ["context_degradation", "impulsivity", "task_abandonment", "over_engineering", "hallucination"]
            for detector in detectors:
                results[f"{detector}_accuracy"] = {"passed": self.validate_detector_accuracy(detector)}

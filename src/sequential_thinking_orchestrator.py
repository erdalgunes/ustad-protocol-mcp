...
class SequentialThinkingOrchestrator:
    ...
    async def think_with_scaffolding(
        ...
        problem: str,
        effort: ReasoningEffort = "medium",
        preferred_model: Optional[ReasoningModel] = None
    ) -> Dict[str, Any]:
        """
    ...
    def _select_model(self, preferred: Optional[ReasoningModel], effort: ReasoningEffort) -> ReasoningModel:
    ...
    def _check_biases(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "confidence": 0.7 if biases else 0.9
        }

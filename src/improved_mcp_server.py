...
class ElicitationResponse(BaseModel):
    ...
    suggestions: Optional[List[str]] = Field(default=None, description="Suggested values")
    ...
    try:
        ...
        if "empty" in str(e).lower():
            return ElicitationResponse(
                ...
                suggestions=["Let me think about this problem...", "First, I need to understand..."]
            ).model_dump()
        raise
...
async def think_advanced(
    ...
    try:
        ...
        return ElicitationResponse(
            field="thought",
            prompt=f"Something went wrong: {str(e)}. Try rephrasing your thought.",

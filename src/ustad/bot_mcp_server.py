...
from .generic_bot import BatchOfThought, ThoughtScorer, ThoughtGenerator
            ...
            try:
                ...
                for i, batch in enumerate(batches):
                    iteration_data = {
                        ...
                        "consensus": batch.consensus,
                        "converged": batch.best_thought.score >= convergence_threshold if batch.best_thought and batch.best_thought.score else False
                    }

...
class TruePerfectBatchOfThought:
    ...
    def generate_thought(
        ...
        """
        prompt = PERSPECTIVE_PROMPTS[perspective].format(problem=problem, context=context)
        ...
        return {
            ...
            "prompt": prompt,
            "requires_llm": True,
            "metadata": {"engine": "true_perfect", "reasoning_type": "actual_ai"},
        }
...
if __name__ == "__main__":
    ...
    result = bot.think("How do we reduce cart abandonment?", "40% rate, mobile users, 5 steps")

...
from .advanced_evaluation import AdvancedEvaluator, MinimaxSearcher, ParallelBotAnalyzer
        ...
        async def analyze_position(fen: str) -> str:
            ...
            try:
                ...
                for move in list(board.legal_moves)[:10]:
                    ...
                    board.pop()
                    top_moves.append({"move": move.uci(), "san": board.san(move), "score": score})
                ...
                for move_uci in moves:
                    try:
                        ...
                        if move in board.legal_moves:
                            ...
                            results.append({"move": move_uci, "error": "Illegal move"})
                    except:
                        results.append({"move": move_uci, "error": "Invalid move format"})

                return json.dumps({"fen": fen, "comparisons": results}, indent=2)

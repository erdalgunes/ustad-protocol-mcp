...
class TestThoughtBatch:
    ...
    def test_batch_creation(self):
        ...
        thoughts = [Thought(content=f"Move {i}", confidence=0.5 + i * 0.1) for i in range(3)]
...
class TestThoughtScorer:
    ...
    def test_score_batch(self):
        ...
        scorer = ThoughtScorer()
        thoughts = [Thought(content=f"Strategy {i}", confidence=0.5 + i * 0.15) for i in range(4)]
        ...
        assert scored_batch.best_thought.score == max(t.score for t in scored_batch.thoughts)
    ...
    def test_custom_scoring_function(self):
        ...
        def chess_scorer(thought: Thought, context: str) -> float:
            ...
            if "attack" in thought.content.lower():
                return 0.9
            if "defend" in thought.content.lower():
                return 0.6
            return 0.5

...
class TestMCPIntegration:
    ...
    async def test_thought_with_revision(self):
        ...
        from sequential_thinking_mcp_server import reset_thinking_session, sequential_thinking
        ...
        await sequential_thinking(
            thought="Initial analysis", thought_number=1, total_thoughts=3, next_thought_needed=True
        )
    ...
    async def test_branching_functionality(self):
        ...
        # Add initial thought
        await sequential_thinking(
            thought="Main path", thought_number=1, total_thoughts=3, next_thought_needed=True
        )
    ...
    async def test_thinking_summary(self):
        ...
        from sequential_thinking_mcp_server import (
        ...
        await sequential_thinking(
            thought="Step 1", thought_number=1, total_thoughts=2, next_thought_needed=True
        )

        await sequential_thinking(
            thought="Step 2 - Final", thought_number=2, total_thoughts=2, next_thought_needed=False
        )
    ...
    async def test_reset_session(self):
        ...
        # Add a thought
        await sequential_thinking(
            thought="Some thought", thought_number=1, total_thoughts=1, next_thought_needed=False
        )
    ...
    async def test_dynamic_total_adjustment(self):
        ...
        # Start with 3 total
        await sequential_thinking(
            thought="Initial estimate", thought_number=1, total_thoughts=3, next_thought_needed=True
        )
    ...
    async def test_completion_detection(self):
        ...
        await sequential_thinking(
            thought="Working on it", thought_number=1, total_thoughts=2, next_thought_needed=True
        )

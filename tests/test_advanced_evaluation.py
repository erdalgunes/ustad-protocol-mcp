...
class TestBotEvaluationThread:
    ...
    def test_material_thread(self):
        ...
        thread = BotEvaluationThread(
            name="Material", weights={"material": 0.8, "position": 0.2}, depth=3
        )
    ...
    def test_tactical_thread(self):
        ...
        thread = BotEvaluationThread(
            name="Tactical", weights={"tactics": 0.7, "material": 0.3}, depth=4
        )
    ...
    def test_positional_thread(self):
        ...
        thread = BotEvaluationThread(
            name="Positional", weights={"position": 0.6, "pawn_structure": 0.4}, depth=3
        )
